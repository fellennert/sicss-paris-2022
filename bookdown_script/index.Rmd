...
Chapter 2 introduces web scraping. You will become familiar with making calls to different structured web pages through `rvest` and `rselenium`). APIs and how you can tap them will be introduced, too.

Chapter 3 gives you insight to techniques for scraping unstructured web pages. This is usually achieved using CSS selectors.

Chapter 4 is dedicated to the featurization and descriptive analysis of text.

Chapter 5 introduces both unsupervised and supervised machine learning approaches for the classification and analysis of text. Moreover, a glimpse on how word embedding techniques can be used as preprocessing technique is provided.
